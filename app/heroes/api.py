...
async def create_hero(data: HeroCreate, heroes: HeroesCRUD = Depends(get_heroes_crud)):
...
async def get_hero_by_uuid(hero_id: str, heroes: HeroesCRUD = Depends(get_heroes_crud)):
...
async def patch_hero_by_uuid(
    hero_id: str, data: HeroPatch, heroes: HeroesCRUD = Depends(get_heroes_crud)
):
...
async def delete_hero_by_uuid(
    hero_id: str, heroes: HeroesCRUD = Depends(get_heroes_crud)
):
